...
static char *g_TexturName[TEXTURE_MAX] = {
	"data/TEXTURE/background_02.jpg",
	"data/TEXTURE/result_logo.png",
	"data/TEXTURE/number_score.png",
	"data/TEXTURE/number16x32_vol2.png",
	"data/TEXTURE/number16x32_vol3.png",
	"data/TEXTURE/number16x32_vol4.png",
};
...
void DrawResult(void)
{
	...
	// スコア表示
	{
		...
		{
			// テクスチャ設定
			GetDeviceContext()->PSSetShaderResources(0, 1, &g_Texture[rank]);
